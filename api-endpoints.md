...
备注：鬼知道会不会改需求 就先加个excel字段了 反正不影响
...
[
    {
        ...
        "place": "aaa", // 收储地点
        "enterPrice": "12345678.90", // 入馆价值
        "leavePrice": "12345678.90", // 离馆价值
        "statusId": 1, // 状态id
        "lastCheckTime": "2020-04-25 11:11:11", // 最后盘点时间
        "enterTime": "2020-04-25 11:11:11", // 入馆时间
        "leaveTime": "2020-04-25 11:11:11", // 离馆时间
        "moveTime": "2020-04-25 11:11:11", // 移入仓库时间
        "lendTime": "2020-04-25 11:11:11", // 出借时间
        "comment": "a" // 备注
    }
]
```
...
`GET /api/v1/warehouses/{warehouseId}?excel={boolean}&from={datestring}&to={datestring}`
